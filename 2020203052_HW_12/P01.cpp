...
void init(){
    ...
    cout<<"Keyborad input: v for the top, front, bird-eye view"<<endl;
...
void keyborad(GLFWwindow* window, int key, int scancode, int action, int mods){
